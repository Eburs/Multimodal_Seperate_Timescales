...
class Saver:
    ...
    def save_mse(self, epoch):
        self.writer.add_scalar(
            "mse/5_step", self.model.evaluator.get_n_step_mse(5), epoch
        )
        self.writer.add_scalar(
            "mse/10_step", self.model.evaluator.get_n_step_mse(10), epoch
        )
        self.writer.add_scalar(
            "mse/15_step", self.model.evaluator.get_n_step_mse(15), epoch
        )
    ...
    def save_model(self, epoch):
        ...
        """
        torch.save(
            self.model.state_dict(), os.path.join(self.path, f"model_{epoch}.pt")
        )
